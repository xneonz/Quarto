public class DefaultQuartoAgent {
	...
	public static void main(String[] args) {
		...
		DefaultQuartoAgent defaultQuartoAgent = new DefaultQuartoAgent(gameClient, stateFileName);
		defaultQuartoAgent.play();
	...
	//class constructor
	public DefaultQuartoAgent(GameClient gameClient, String stateFileName) {
